...
Esse projeto foi desenvolvido em um grupo de 3 pessoas, foi usado ReactJS, API's, React Hooks, Context API e outras tecnologias. 
E trata-se de um aplicativo de receitas onde é possível fazer login com validação de e-mail e senha, buscar e filtar receitas, além de favoritar e poder acompanhar o progresso de uma receita sem perder o progresso mesmo após fechar ou atualizar a página.
